...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; NOTE: In order for 'doom' or 'all-the-icons' themes to work fine, 'all-the-icons' fonts
   ;; must be installed. To do that, run M-x 'all-the-icons-install-fonts'
